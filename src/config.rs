...
pub struct Settings {
    ...
    /// AUL/EVTX/journald/intrusion_log/biome — their own timestamps are
    /// already absolute, see `parsers::text_config`'s doc comment for why
    /// only text sources ever need an assumed timezone at all.
